...
class BaseConfig:
    ...
    # Data paths
    data_root: str = os.environ.get("HECKTOR_DATA_ROOT", "./data")
    train_images_dir: str = "."
    train_labels_dir: str = "."
    
    # HECKTOR 2026 unified pipeline metadata
    staging_csv: str = "HECKTOR_2026_training_data.csv"
    rfs_csv: str = "HECKTOR_2026_training_data.csv"
    splits_file: str = "config/splits_final.json"
    
    # Data properties
    input_channels: int = 2  # CT + PET
    num_classes: int = 3     # background + primary tumor (GTVp) + lymph nodes (GTVn)
