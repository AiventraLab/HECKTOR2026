...
class BaseModel(nn.Module, ABC):
    ...
    def forward_unified(self, x: torch.Tensor) -> Dict[str, torch.Tensor]:
        """
        HECKTOR 2026 unified pipeline forward pass.
        Returns segmentation + optional staging + risk score.
        """
